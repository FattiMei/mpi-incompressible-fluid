...
void C2Decomp::transposeY2X_Start(MPI_Request &handle, double *src, double *dst,
  ...
  MPI_Ialltoallv(sbuf, decompMain.y1cnts, decompMain.y1disp, realType, rbuf,
                 decompMain.x1cnts, decompMain.x1disp, realType,
                 DECOMP_2D_COMM_COL, &handle);
}

void C2Decomp::transposeY2X_Wait(MPI_Request &handle, double *src, double *dst,
                                 double *sbuf, double *rbuf) {
...
void C2Decomp::transposeY2X_MajorIndex_Start(MPI_Request &handle, double *src,
...
void C2Decomp::transposeY2X_MajorIndex_Wait(MPI_Request &handle, double *src,
                                            double *dst, double *sbuf,
                                            double *rbuf) {
