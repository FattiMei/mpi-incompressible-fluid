...
Constants::Constants(size_t Nx_domains_global, size_t Ny_domains_global, size_t Nz_domains_global, 
                     Real x_size_global, Real y_size_global, Real z_size_global, Real Re, 
                     Real final_time, unsigned int num_time_steps,
                     int Px, int Py, int x_rank, int y_rank)
    : Nx_domains_global(Nx_domains_global), Ny_domains_global(Ny_domains_global), Nz_domains_global(Nz_domains_global),
      x_size_global(x_size_global), y_size_global(y_size_global), z_size_global(z_size_global), 
      ...
      Nz_domains_local(Nz_domains_global), Nx(Nx_domains_local + 1UL), Ny(Ny_domains_local + 1UL), 
      Nz(Nz_domains_local + 1UL), x_size_local(x_size_global / Px), y_size_local(y_size_global / Py),
      z_size_local(z_size_global), min_x(x_size_local * x_rank), max_x(min_x + x_size_local),
      min_y(y_size_local * y_rank), max_y(min_y + y_size_local),
      min_z(0), max_z(z_size_local) {
